...
const tumUrunler = urunler.filter((u) => u.kategori === 'gunes-bakimi')

const altKategoriler = [
  { id: 'gunes-kremi', ad: 'Güneş Kremi' },
  { id: 'gunes-spreyi', ad: 'Güneş Spreyi' },
  { id: 'gunes-sutü', ad: 'Güneş Sütü' },
  { id: 'after-sun', ad: 'Güneş Sonrası' },
]

export default function GunesKoruyucuSayfasi() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="bg-gradient-to-br from-orange-50 via-amber-50 to-rose-50 border-b border-rose-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-4xl">☀️</span>
            <h1 className="text-4xl font-bold text-stone-900">Güneş Koruyucu</h1>
          </div>
          <p className="text-stone-500">SPF30, SPF50+ güneş koruma ürünleri — {filtreliUrunler.length} ürün</p>
        </div>
      </div>
