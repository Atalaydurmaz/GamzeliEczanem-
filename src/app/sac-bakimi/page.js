...
import { getSacBakimiUrunleri, sacBakimiKategorileri } from '@/lib/data'
...
const tumUrunler = getSacBakimiUrunleri()

export default function SacBakimiSayfasi() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="bg-gradient-to-br from-emerald-50 via-teal-50 to-rose-50 border-b border-rose-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-4xl">💇</span>
            <h1 className="text-4xl font-bold text-stone-900">Saç Bakımı</h1>
          </div>
          <p className="text-stone-500">Şampuan, maske, serum ve bakım yağları — {filtreliUrunler.length} ürün</p>
        </div>
      </div>
