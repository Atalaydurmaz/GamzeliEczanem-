...
import { getCiltBakimiUrunleri, ciltBakimiKategorileri } from '@/lib/data'
...
const tumUrunler = getCiltBakimiUrunleri()

export default function YuzBakimiSayfasi() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="bg-gradient-to-br from-purple-50 via-rose-50 to-pink-50 border-b border-rose-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-4xl">🧖‍♀️</span>
            <h1 className="text-4xl font-bold text-stone-900">Yüz Bakımı</h1>
          </div>
          <p className="text-stone-500">Nemlendirici, serum, temizleyici ve daha fazlası — {filtreliUrunler.length} ürün</p>
        </div>
      </div>
