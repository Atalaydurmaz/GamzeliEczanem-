...
export const TR_ILLER = {
  ...
  'Çorum': ['Alaca','Bayat','Boğazkale','Dodurga','İskilip','Kargı','Laçin','Mecitözü','Oğuzlar','Ortaköy','Osmancık','Çorum Merkez','Sungurlu','Uğurludağ'],
  ...
  'Samsun': ['Alaçam','Asarcık','Atakum','Ayvacık','Bafra','Canik','Çarşamba','İlkadım','Kavak','Ladik','19 Mayıs','Salıpazarı','Tekkeköy','Terme','Vezirköprü','Yakakent'],
  ...
  'Yozgat': ['Akdağmadeni','Aydıncık','Boğazlıyan','Çandır','Çayıralan','Çekerek','Kadışehri','Saraykent','Sarıkaya','Sorgun','Şefaatli','Yenifakılı','Yozgat Merkez','Yerköy'],
  'Zonguldak': ['Alaplı','Çaycuma','Devrek','Gökçebey','Kilimli','Kozlu','Zonguldak Merkez'],
}

export const IL_LISTESI = Object.keys(TR_ILLER).sort()
