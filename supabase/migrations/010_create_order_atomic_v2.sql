-- create_order_atomic v2 — duplicate sipariş koruması eklendi
--
-- unique_violation (23505) yakalandığında:
--   • O ana kadar yapılan tüm stok UPDATE'leri geri alınır (subtransaction rollback)
--   • RAISE EXCEPTION 'DUPLICATE_ORDER:<siparis_no>' ile sinyal verilir
--   • Çağıran taraf idempotent yanıt dönebilir
...
EXCEPTION
  ...
  WHEN unique_violation THEN
    -- EXCEPTION bloğu implicit savepoint oluşturur;
    -- yukarıdaki tüm stok UPDATE'leri bu noktada otomatik geri alınır.
